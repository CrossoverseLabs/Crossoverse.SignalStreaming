...
{
    public sealed class BufferedSignalStreamingChannelV2 : IBufferedSignalStreamingChannelV2
    {
        ...
        public BufferedSignalStreamingChannelV2
        (
            string id,
        ...
        public async UniTask DisposeAsync()
        {
            ...
            DevelopmentOnlyLogger.Log($"<color=lime>[{nameof(BufferedSignalStreamingChannelV2)}] Disposed.</color>");
        }
        ...
        public async UniTask<bool> ConnectAsync(CancellationToken token = default)
        {
            ...
            if (_isConnected)
            {
                DevelopmentOnlyLogger.Log($"<color=orange>[{nameof(BufferedSignalStreamingChannelV2)}] Already connected.</color>");
                return true;
            }
        ...
        {
            DevelopmentOnlyLogger.Log($"<color=lime>[{nameof(BufferedSignalStreamingChannelV2)}] SendSignal</color>");
        ...
        {
            DevelopmentOnlyLogger.Log($"<color=lime>[{nameof(BufferedSignalStreamingChannelV2)}] HandleTransportMessage</color>");
            ...
            if (arrayLength != 3)
            {
                DevelopmentOnlyLogger.LogError($"[{nameof(BufferedSignalStreamingChannelV2)}] The received message is unsupported format.");
            }
